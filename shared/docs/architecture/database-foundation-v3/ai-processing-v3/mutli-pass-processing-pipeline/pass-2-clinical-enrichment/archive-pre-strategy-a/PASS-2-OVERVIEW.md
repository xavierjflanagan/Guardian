...
Pass 2 takes the entity detection results from Pass 1 (via db table) and extracts structured clinical information using AI-powered analysis combined with bridge schema guidance. The output populates Pass 2 database tables with healthcare-grade structured data.
