-- =============================================================================
-- FINAL SOLUTION: Use #variable_conflict directive
-- =============================================================================
-- Problem: RETURNS TABLE column names conflict with table column names
-- Solution: Use PostgreSQL's #variable_conflict use_column directive
-- This tells PostgreSQL to prefer table columns over function parameters
-- Created: 2025-09-03
-- =============================================================================
...
AS $$
#variable_conflict use_column  -- CRITICAL: This resolves ambiguity between function columns and table columns
DECLARE
...
BEGIN
    ...
    RETURNING id, job_type, job_payload, retry_count;  -- Now unambiguous due to #variable_conflict
END;
$$;