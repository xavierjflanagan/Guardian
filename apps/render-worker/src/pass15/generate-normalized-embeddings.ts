 ...
 */
async function createEmbeddingBatch(): Promise<string | null> {
  try {
 ...
 */
async function displaySampleResults(limit: number = 10): Promise<void> {
  console.log('\n' + '='.repeat(80));
 ...
 */
async function generateNormalizedEmbeddings(testRun: boolean = false): Promise<void> {
