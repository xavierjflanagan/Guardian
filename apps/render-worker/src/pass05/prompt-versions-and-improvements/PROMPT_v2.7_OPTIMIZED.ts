/**
 * Pass 0.5 Healthcare Encounter Discovery Prompt - v2.7
 *
 ...
 *
 * Version History:
 * v2.7 (Nov 5, 2025) - Logic Bug Fixes (GPT-5 review findings)
 *    - FIXED: Date precision inconsistency (allow YYYY-MM or YYYY-MM-DD in output)
 *    - FIXED: Planned encounters rule conflict (exempt planned from isRealWorldVisit=true rule)
 *    - FIXED: Page assignment contradiction (removed "skip pages" option)
 *    - Production ready
 * v2.6 (Nov 5, 2025) - Schema Alignment Fix
 *    - Fixed JSON field names to match TypeScript interfaces
...
export const PASS_05_PROMPT_V27 = `
...
export const getOptimizedPromptV27 = (): string => {
  return PASS_05_PROMPT_V27;
};