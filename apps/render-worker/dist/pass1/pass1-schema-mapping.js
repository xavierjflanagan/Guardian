...
exports.ENTITY_SCHEMA_MAPPING = void 0;
exports.determineProcessingPriority = determineProcessingPriority;
exports.assignEntitySchemas = assignEntitySchemas;
exports.assessEnrichmentComplexity = assessEnrichmentComplexity;
exports.validateSchemaMapping = validateSchemaMapping;
exports.requiresPass2Enrichment = requiresPass2Enrichment;
exports.getUniqueSchemas = getUniqueSchemas;
exports.countEntitiesByPriority = countEntitiesByPriority;
// =============================================================================
 ...
 */
function determineProcessingPriority(entityCategory, entitySubtype) {
 ...
 */
function assignEntitySchemas(entitySubtype) {
    const schemas = exports.ENTITY_SCHEMA_MAPPING[entitySubtype];
    if (!schemas) {
 ...
 */
function assessEnrichmentComplexity(entitySubtype) {
...
function validateSchemaMapping() {
    ...
    for (const subtype of allSubtypes) {
        if (!(subtype in exports.ENTITY_SCHEMA_MAPPING)) {
 ...
 */
function requiresPass2Enrichment(entitySubtype) {
    const schemas = assignEntitySchemas(entitySubtype);
 ...
 */
function getUniqueSchemas(entitySubtypes) {
 ...
 */
function countEntitiesByPriority(entities) {
    const counts = {
        highest: 0,
        high: 0,
        medium: 0,
...
//# sourceMappingURL=pass1-schema-mapping.js.map