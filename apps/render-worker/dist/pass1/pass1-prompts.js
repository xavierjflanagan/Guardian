...
exports.PASS1_SYSTEM_MESSAGE_OCR_ONLY = exports.PASS1_SYSTEM_MESSAGE = void 0;
exports.generatePass1ClassificationPrompt = generatePass1ClassificationPrompt;
exports.generateValidationPrompt = generateValidationPrompt;
exports.generateErrorRecoveryPrompt = generateErrorRecoveryPrompt;
exports.generatePass1ClassificationPromptOCROnly = generatePass1ClassificationPromptOCROnly;
exports.truncateOCRText = truncateOCRText;
exports.formatSpatialMapping = formatSpatialMapping;
// =============================================================================
...
// =============================================================================
function generatePass1ClassificationPrompt(input, modelName = 'vision-model') {
    return `
...
// =============================================================================
function generateErrorRecoveryPrompt(errorDetails, documentSegment) {
    return `
 ...
 */
function generatePass1ClassificationPromptOCROnly(enhancedOCR, modelName = 'gpt-4o-mini') {
    return `
 ...
 */
function truncateOCRText(text, maxLength = 2000) {
 ...
 */
function formatSpatialMapping(spatialMapping, maxElements = 100) {
...
//# sourceMappingURL=pass1-prompts.js.map