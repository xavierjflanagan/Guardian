...
exports.MINIMAL_SYSTEM_MESSAGE = void 0;
exports.generateMinimalListPrompt = generateMinimalListPrompt;
// =============================================================================
 ...
 */
function generateMinimalListPrompt(_input) {
    return `
 ...
 */
exports.MINIMAL_SYSTEM_MESSAGE = `You are a medical document entity classifier. Extract EVERY piece of information as separate classified entities. Never summarize lists. Always split combination items into separate entities.`;
//# sourceMappingURL=pass1-prompts-minimal-test.js.map